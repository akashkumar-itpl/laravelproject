...
quantityNumberStop($(".quantity__number").val());
$("body").on("click", ".increase", function (e) {
  // alert($(this).attr("id"));
  // console.log($(".quantity__number").val());
  quantityNumberStop($("#quantity__number" + $(this).attr("id")).val(), $(this).attr("id"));
});
...
$(".shop").on("click", ".loading__button", function (e) {
  page++;
  infinteLoadMore(page);
});
...
$(".shop").on("click", '.filters', function () {
  page = 1;
...
$(".shop").on("click", '.filterByPrice', function () {
  page = 1;
  $(".productAjaxDiv").empty();
  infinteLoadMore(page);
});
$(".shop").on("click", '.attributesFilter', function () {
  page = 1;
  $(".productAjaxDiv").empty();
  infinteLoadMore(page);
});
$(".shop").on("submit", 'form', function (event) {
...
function quantityNumberStop(Value,id) {
  if (Value <= '1') {

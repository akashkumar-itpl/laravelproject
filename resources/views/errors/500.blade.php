...
@section('metaTitle', '500 Server Error')
@section('metaKey', '500 Server Error')
@section('metaDescription', '500 Server Error')
@section('canonicalUrl', '500 Server Error')
@section('content')
...
.thankyou img{ margin-bottom:20px;}
	...
	<div class="container">
		  ...
		  <div class="col-md-12 text-center">
           ...
           <h1 style="font-size:50px;"><strong>500 Page not Found</strong></h1>

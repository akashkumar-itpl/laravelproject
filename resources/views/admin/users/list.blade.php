...
@section('page_title', 'Manage authorisation')
@section('info', 'Manage Authorisation')
@section('Appearance', 'menu-open')
@section('authorisation_list', 'active')
@section('container')
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="font-size: 1.6em">Manage Users <sup><a href="#" data-toggle="tooltip"
                            data-placement="top" title="@yield('info')"><i class="fa fa-info-circle"></i></a></sup></h3>
                <div class="card-tools">
                    {{-- <a href="{{ url('admin/add-authorisation') }}" class="btn btn-success badge">Add <small><i
                                class="right fas fa-plus"></i></small></a> --}}

                    | <a onClick="multiTaskOperation('Delete',this)" data-taskurl="{{ url('admin/user-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Activate',this)" data-taskurl="{{ url('admin/user-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Block',this)" data-taskurl="{{ url('admin/user-multitask') }}"
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="table-checkbox text-center align-middle" width="4%"><input type="checkbox"
                                    class="group-checkable" data-set="#pageple1 .checkboxes" /></th>
    ...
    <script>
        $(function() {
            $('#example1').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.usermanagementList') }}",
                columns: [{
                        data: 'id'
                    },
                    {

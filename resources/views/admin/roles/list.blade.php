...
@section('info', 'Manage Roles For Admins.')
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ url('admin/add-roles') }}" class="btn btn-success badge">Add <small><i
                                class="right fas fa-plus"></i></small></a>
                    | <a onClick="multiTaskOperation('Delete',this)" data-taskurl="{{ url('admin/roles-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Activate',this)" data-taskurl="{{ url('admin/roles-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Block',this)" data-taskurl="{{ url('admin/roles-multitask') }}"

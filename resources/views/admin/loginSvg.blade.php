<svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <circle cx="100" cy="100" r="100" fill="#e1bfa3" />
    <g class="body">
        <path fill="#FFFFFF"
        ...
        <path fill="none" stroke="#00124b" stroke-width="2.5" stroke-linecap="round" stroke-linejoinn="round"
    ...
    <g class="earL">
        <g class="outerEar" fill="#8a8fa1" stroke="#00124b" stroke-width="2.5">
        ...
        <g class="earHair">
            ...
            <path
                ...
                fill="#fff" stroke="#00124b" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
        </g>
    </g>
    <g class="earR">
        <g class="outerEar" fill="#8a8fa1" stroke="#00124b" stroke-width="2.5">
    ...
    <path class="chin"
        ...
        fill="none" stroke="#00124b" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
    <path class="face" fill="#8f6471"
        d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46" />
    <path class="hair" fill="#FFFFFF" stroke="#00124b" stroke-width="2.5" stroke-linecap="round"
        stroke-linejoin="round"
    ...
    <g class="eyebrow">
        ...
        <path fill="#FFFFFF" stroke="#00124b" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
    ...
    <g class="eyeL">
        <circle cx="85.5" cy="78.5" r="3.5" fill="#00124b" />
        <circle cx="84" cy="76" r="1" fill="#fff" />
    </g>
    <g class="eyeR">
        <circle cx="114.5" cy="78.5" r="3.5" fill="#00124b" />
    ...
    <g class="mouth">
        ...
        <path style="display: none;" class="mouthLargeBG"
            ...
            fill="#617e92" stroke="#00124b" stroke-linejoin="round" stroke-width="2.5" />
        <defs>
        ...
        <path class="mouthOutline" fill="none" stroke="#00124b" stroke-width="2.5" stroke-linejoin="round"
            d="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z" />
    </g>
    <path class="nose"
    ...
    <g class="arms" clip-path="url(#armMask)">
        <g class="armL">
            <path fill="#8a8fa1" stroke="#00124b" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
            ...
            <path fill="#fff" stroke="#00124b" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"

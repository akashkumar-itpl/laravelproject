...
<style> .content {
    ...
    <div class="content-wrapper">
        ...
        <!-- /.content-header -->
        <form
            action="@if ($id == '') {{ route('admin.add-sustainabilitys-form') }} @else {{ route('admin.update-sustainabilitys-form', $id) }} @endif"
            ...
            <div class="card">
                <div class="card-header card-header-sticky">
                    ...
                    <div class="card-tools">
                        ...
                        |
                        <a href="{{ url('admin/sustainabilitys') }}" class="btn btn-warning btn-sm btn-badge"><i
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header bg-primary mb-20">
                                <h3 class="card-title">Sustainabilitys Info</h3>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($image != '')
                                    <a href="{{ asset('storage/media/sustainabilitys/' . $image) }}" target="_blank"><img
                                    width="100px" src="{{ asset('storage/media/sustainabilitys/' . $image) }}" /></a>
                                    @endif

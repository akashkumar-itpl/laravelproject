...
@section('info', 'Manage Footer Section.')
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ url('admin/add-footer') }}" class="btn btn-success badge">Add <small><i
                                class="right fas fa-plus"></i></small></a>
                    | <a onClick="multiTaskOperation('Delete',this)" data-taskurl="{{ url('admin/footer-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Activate',this)" data-taskurl="{{ url('admin/footer-multitask') }}"
                    ...
                    | <a onClick="multiTaskOperation('Block',this)" data-taskurl="{{ url('admin/footer-multitask') }}"
    ...
    <script>
        $(function() {
            $('#example1').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.ajaxFooterList') }}",
                columns: [{
                        data: 'id'
                    },
                    {
